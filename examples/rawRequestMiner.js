                ...
                if(open){
                  ...
                  try{
                    ...
                    Request(request.url,(error, response, body)=>{
                      ...
                      //before we throw this on the blockchain, let's do some sanity checks on the data
                      // we will have to stake some token on this answer so let's make sure it's good
                      //assuming everything will be within a certain length:
